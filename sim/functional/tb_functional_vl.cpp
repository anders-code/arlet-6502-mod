...
int main(int argc, char** argv, char** env)
{
    ...
    Vfunctional *dut = new Vfunctional(context);
    ...
    while (sim_time < RUN_TIME && dut->rootp->tb_functional_vl__DOT__cpu_inst__DOT__PC != 0x3469 || dut->clk)
    {
        dut->clk ^= 1;
        dut->eval();
#if VM_TRACE
